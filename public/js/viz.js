(function() {
  ...
  drawSentiments = function() {
    ...
    if (json.sentiment.document.score*100 > 0) {
      ...
      text6 = svgContainer.append("text").attr("x", 37).attr("y", 275).text("Sentiment (Positive)").attr("font-family", "georgia").attr("font-size", "14px").attr("fill", "black");
    }
    if (json.sentiment.document.score*100 < 0) {
      ...
      text7 = svgContainer.append("text").attr("x", 37).attr("y", 275).text("Sentiment (Negative)").attr("font-family", "georgia").attr("font-size", "14px").attr("fill", "black");
    }
  };
